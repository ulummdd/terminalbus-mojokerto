  		...
  		<div class="col s9 navbar" style="padding:0px !important;">
  			...
  			<div class="row dashboard">
  				<div class="col s8 dashboard-content">
  					<h4 style="color:#fff">Detail informasi</h4>
  					<h6 style="color:#999;">"
  						<?php 
  				...
  				<div class="col s12">
  					<div class="input-field" style="margin:30px 0px 0px 0px !important;width:500px !important;">
  						<input type="text" id="judul_informasi" style="color:white;border-bottom:1px solid #999;" value="<?php echo $data['pembuat']; ?>" disabled>
          				<label for="judul_informasi" style="color:white;">Dibuat oleh</label>
        			</div>
        			<div class="input-field" style="margin:30px 0px 0px 0px !important;width:500px !important;">
  						<input type="text" id="judul_informasi" style="color:white;border-bottom:1px solid #999;" value="<?php echo $data['waktu_dibuat']; ?>" disabled>
          				<label for="judul_informasi" style="color:white;">Waktu dibuat</label>
        			</div>
  					<div class="input-field" style="margin:30px 0px 0px 0px !important;width:500px !important;">
  						<input type="text" id="judul_informasi" style="color:white;border-bottom:1px solid #999;" value="<?php echo $data['judul_informasi']; ?>" disabled>
          				<label for="judul_informasi" style="color:white;">Judul</label>
        			</div>
        			<div class="input-field" style="margin:30px 0px 20px 0px !important;width:500px !important;">
            			<textarea id="desc_information" style="color:white;border-bottom:1px solid #999;"  class="materialize-textarea" data-length="250" disabled><?php echo $data['isi_informasi']; ?></textarea>
            			<label for="desc_information" style="color:white;">Isi pengumuman</label>
          			</div>
          			<a href="edit-information.php?id=<?php echo $_GET['id']; ?>" class="btn edit-data-information">Edit data</a>
  				</div>
  						<?php
							}
  						?>
