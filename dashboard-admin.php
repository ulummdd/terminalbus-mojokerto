  		...
  		<div class="col s9 navbar" style="padding:0px !important;">
  			...
  			<div class="row dashboard">
  				<div class="col s8 dashboard-content">
  					...
  					<h6 style="color:#999;">Halo, <?php echo $_SESSION['id']; ?></h6>
  					<div class="row" style="margin-top:30px;">
  						<div class="col s5">
  							<div class="ongoing">
  								<b style="font-size:22px;">Pesan diterima</b>
  								<p>Ada <b>
  							<?php
							...
							?>
  								</b> pesan yang telah dikirim oleh pengguna website Bus Mojokerto</p>
  								<a href="message.php" class="btn-ongoing">Lihat pesan</a>
  							</div>
  						</div>
  						<div class="col s5">
  							<div class="tutor">
  								<b style="font-size:22px;">Kupon</b>
  								<p>Buat dan gunakan kupon untuk penumpang Bus Mojokerto</p>
  								<a href="coupon-admin.php" class="btn-tutor">Selengkapnya</a>
  							</div>
  						</div>
  					</div>
  				</div>
